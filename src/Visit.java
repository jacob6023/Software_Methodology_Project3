...
public class Visit {
     ...
     * You can add  constructors and methods, but you CANNOT add/change the instance variables, or -2 points for each violation.
     */
    public Visist(Appointment appointment){
